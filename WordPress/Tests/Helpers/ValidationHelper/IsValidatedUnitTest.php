...
final class IsValidatedUnitTest extends UtilityMethodTestCase {
	...
	public static function dataIsValidatedLiveCoding() {
		return array(
			'construct_not_followed_by_parenthesis' => array(
				'testCaseFile' => 'IsValidatedConstructLiveCodingUnitTest.inc',
			),
	...
	/**
	 * Test is_validated() with $in_condition_only set to the default (false).
	 *
	 ...
	 * @return void
	 */
	public function testIsValidated( $testMarker, $expectedResult, $array_keys = array( 'key' ) ) {
	...
	public static function dataIsValidated() {
		return array(
			...
			'construct_param_key_mismatch' => array(
			...
			'multi_level_construct' => array(
				'testMarker'     => '/* testMultiLevelConstruct */',
				'expectedResult' => true,
			...
			'string_array_key' => array(
				'testMarker'     => '/* testValidatedWithIsset */',
				'expectedResult' => true,
				'array_keys'     => 'key',
			),
			'function_call_multi_level' => array(
				'testMarker'     => '/* testFunctionCallMultiLevel */',
				'expectedResult' => true,
